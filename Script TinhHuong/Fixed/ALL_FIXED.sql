...
BEGIN TRAN sp_them_NhaBan
	SET TRANSACTION ISOLATION LEVEL READ COMMITTED
	INSERT INTO NhaBan(MaNha,SoLuongPhong,GiaBan,DieuKien,NgayDang, NgayHetHan, SoLuotXem, TinhTrangBan) VALUES (@maNha, @soLuongPhong ,@giaBan, N'Dat coc truoc 20%', GETDATE(), @ngayHetHan, 0, 1)
